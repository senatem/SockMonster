...
class PauseScene: Scene("pause", 0f){
    ...
    init {
        ...
        mainDistrict.addFullPlot("resume", Rectangle(852f / 1280f, 1230f / 1280f, 258f / 720f, 380f / 720f)).also {
            it.element = SetButton("resume",SingleTexture(Gdx.files.internal("pause/resume_normal.png")),SingleTexture(Gdx.files.internal("pause/resume_pressed.png")))
        }

        mainDistrict.addFullPlot("menu", Rectangle(852f / 1280f, 1230f / 1280f, 136f / 720f, 258f / 720f)).also {
            it.element = SetButton("menu",SingleTexture(Gdx.files.internal("pause/main_normal.png")),SingleTexture(Gdx.files.internal("pause/main_pressed.png")))
        }

        mainDistrict.addFullPlot("exit", Rectangle(1026f / 1280f, 1230f / 1280f, 36f / 720f, 136f / 720f)).also {
            it.element = SetButton("exit",SingleTexture(Gdx.files.internal("pause/exit_normal.png")),SingleTexture(Gdx.files.internal("pause/exit_pressed.png")))
        }
